        ...
        <div class="info">
            <div class="img-meal position-relative" onclick="getMeal(${arr[i].idMeal})">
                ...
                <div class="post d-flex align-items-center position-absolute rounded">
                    <div class="layer">
                        <h2 class="fw-light ms-2">${arr[i].strMeal}</h2>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-md-8 text-white pb-5">
    ...
    <p class="pb-3">${meal.strInstructions}</p>
        <p class="fw-bolder">Area : <span  class="fw-light" >${meal.strArea}</span></p>
        <p class="fw-bolder">Area : <span class="fw-light" >${meal.strCategory}</span></p>
...
let x;
    ...
    if(list == "contact"){
        row.innerHTML=`
        <section>
        <div class="container w-75 m-auto  mb-4">
            <div class="form">
                <h2 class="text-white text-center mb-5">Contact us</h2>
            <div class="row gy-5 ">
                    <div class="col-md-6">
                            <input type="text" id="name" onkeyup="validation()"   placeholder="Name" class="form-control text-white bg-transparent">
                            <div class="alert text-danger text-center d-none" id="namealert"> Special Characters and Numbers not allowed</div>
                    </div>
                    <div class="col-md-6">
                        <input type="email" id="email" onkeyup="validation()"  placeholder="Email" class="form-control text-white bg-transparent">
                        <div class="alert text-danger text-center d-none" id="emailalert">Enter valid email. *Ex: xxx@yyy.zzz</div>
                    </div>
                    <div class="col-md-6">
                        <input type="tel" id="phone" onkeyup="validation()" placeholder="Phone" class="form-control text-white bg-transparent">
                        <div class="alert text-danger text-center d-none" id="phonealert">Enter valid Phone Number</div>
                    </div>
                    <div class="col-md-6">
                        <input type="number" id="age" onkeyup="validation()" placeholder="Age" class="form-control text-white bg-transparent">
                        <div class="alert text-danger text-center d-none" id="agealert">Enter valid Age </div>
                        
                    </div>
                    <div class="col-md-6">
                        <input type="password" id="password" onkeyup="validation()" placeholder="Password" class="form-control text-white bg-transparent">
                        <div class="alert text-danger text-center d-none" id="passalert">Enter valid password Minimum eight characters, at least one letter and one number:</div>
                    </div>
                <div class="col-md-6">
                    <input type="password" id="rePassword" onkeyup="validation()"  placeholder="RePassword" class="form-control text-white bg-transparent">
                    <div class="alert text-danger text-center d-none" id="repassalert">Enter valid Repassword</div>
                </div>
            <div class="col-md-6 offset-5">
                <button class="btn btn-danger   ms-5 bg-transparent " id="submit" disabled>Submit</button>
            </div>
...
function validation(){
    ...
    if(validAge() && validEmail() && validPw() && validPhone() && validName() && validRepw()){
